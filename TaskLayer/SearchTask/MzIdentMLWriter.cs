...
namespace TaskLayer
{
    public static class MzIdentMLWriter
    {
            ...
            Tolerance parentTolerance, int missedCleavages, string outputPath, bool appendMotifToModNames)
        {
            ...
            _mzid.AuditCollection = new mzIdentML120.Generated.AbstractContactType[2];

            _mzid.AuditCollection[0] = new mzIdentML120.Generated.PersonType()
            {
                id = "UWMadisonSmithGroupPerson",
                cvParam = new mzIdentML120.Generated.CVParamType[2]
                {
            ...
            _mzid.AuditCollection[1] = new mzIdentML120.Generated.OrganizationType()
            {
            ...
            _mzid.cvList = new mzIdentML120.Generated.cvType[4] { new mzIdentML120.Generated.cvType()
            {
                id = "PSI-MS",
             ...
             new mzIdentML120.Generated.cvType()
            {
                id = "PSI-MOD",
            ...
            _mzid.AnalysisSoftwareList = new mzIdentML120.Generated.AnalysisSoftwareType[1] {  new mzIdentML120.Generated.AnalysisSoftwareType()
            {
                id = "AS_MetaMorpheus",
                name = "MetaMorpheus",
                version = GlobalVariables.MetaMorpheusVersion,
                uri = "https://github.com/smith-chem-wisc/MetaMorpheus",
                SoftwareName = new mzIdentML120.Generated.ParamType()
                {
                    Item = new mzIdentML120.Generated.CVParamType
                    {
            ...
            _mzid.DataCollection = new mzIdentML120.Generated.DataCollectionType
            {
                AnalysisData = new mzIdentML120.Generated.AnalysisDataType()
                {
                    SpectrumIdentificationList = new mzIdentML120.Generated.SpectrumIdentificationListType[1]
        {
                        new mzIdentML120.Generated.SpectrumIdentificationListType
                        {
                            id = "SIL",
                            SpectrumIdentificationResult = new mzIdentML120.Generated.SpectrumIdentificationResultType[psms.Count()]
                        }
        }
                },
                Inputs = new mzIdentML120.Generated.InputsType
                {
                    SearchDatabase = new mzIdentML120.Generated.SearchDatabaseType[databases.Count()],
                    SpectraData = new mzIdentML120.Generated.SpectraDataType[filenames.Count]
                }
            };

            _mzid.SequenceCollection = new mzIdentML120.Generated.SequenceCollectionType
            {
                Peptide = new mzIdentML120.Generated.PeptideType[peptides.Count],
                DBSequence = new mzIdentML120.Generated.DBSequenceType[proteins.Count],
                PeptideEvidence = new mzIdentML120.Generated.PeptideEvidenceType[peptides.Count]
            };

            _mzid.AnalysisCollection = new mzIdentML120.Generated.AnalysisCollectionType
            {
                SpectrumIdentification = new mzIdentML120.Generated.SpectrumIdentificationType[1]
                {
                    new mzIdentML120.Generated.SpectrumIdentificationType
                    {
                        id = "SI",
                        spectrumIdentificationList_ref = "SIL",
                        spectrumIdentificationProtocol_ref = "SIP",
                        InputSpectra = new mzIdentML120.Generated.InputSpectraType[filenames.Count],
                        SearchDatabaseRef = new mzIdentML120.Generated.SearchDatabaseRefType[databases.Count]
                    }
                }
            };
            ...
            {
                _mzid.DataCollection.Inputs.SearchDatabase[database_index] = new mzIdentML120.Generated.SearchDatabaseType()
                {
                    id = "SDB_" + database_index,
                    location = database,
                    DatabaseName = new mzIdentML120.Generated.ParamType
                    {
                        Item = new mzIdentML120.Generated.CVParamType
                        {
                ...
                _mzid.AnalysisCollection.SpectrumIdentification[0].SearchDatabaseRef[database_index] = new mzIdentML120.Generated.SearchDatabaseRefType()
                {
            ...
            {
                _mzid.SequenceCollection.DBSequence[protein_index] = new mzIdentML120.Generated.DBSequenceType
                {
            ...
            foreach (string data_filepath in filenames)
            {
                ...
                _mzid.AnalysisCollection.SpectrumIdentification[0].InputSpectra[spectra_data_id] = new mzIdentML120.Generated.InputSpectraType()
                {
                    spectraData_ref = spectral_data_id
                };
                _mzid.DataCollection.Inputs.SpectraData[spectra_data_id] = new mzIdentML120.Generated.SpectraDataType()
                {
                    id = spectral_data_id,
                    ...
                    SpectrumIDFormat = new mzIdentML120.Generated.SpectrumIDFormatType
                    {
                        cvParam = new mzIdentML120.Generated.CVParamType
                        {
            ...
            foreach (PeptideSpectralMatch psm in unambiguousPsms)
            {
                foreach (PeptideWithSetModifications peptide in psm.BestMatchingPeptides.Select(p => p.Peptide).Distinct())
                {
                    ...
                    if (!peptide_ids.TryGetValue(peptide.FullSequence, out Tuple<int, HashSet<string>> peptide_id))
                    {
                        ...
                        p_index++;
                        _mzid.SequenceCollection.Peptide[peptide_id.Item1] = new mzIdentML120.Generated.PeptideType
                        {
                            PeptideSequence = peptide.BaseSequence,
                            id = "P_" + peptide_id.Item1,
                            Modification = new mzIdentML120.Generated.ModificationType[peptide.NumMods]
                        };
                        int mod_id = 0;
                        foreach (KeyValuePair<int, Modification> mod in peptide.AllModsOneIsNterminus)
                        {
                            _mzid.SequenceCollection.Peptide[peptide_id.Item1].Modification[mod_id] = new mzIdentML120.Generated.ModificationType()
                            {
                                location = mod.Key - 1,
                    ...
                    {
                        _mzid.SequenceCollection.PeptideEvidence[pe_index] = new mzIdentML120.Generated.PeptideEvidenceType()
                        {
                            id = "PE_" + pe_index,
                ...
                if (!psm_per_scan.TryGetValue(new Tuple<string, int>(psm.FullFilePath, psm.ScanNumber), out Tuple<int, int> scan_result_scan_item)) //check to see if scan has already been added
                {
                    ...
                    _mzid.DataCollection.AnalysisData.SpectrumIdentificationList[0].SpectrumIdentificationResult[scan_result_scan_item.Item1] = new mzIdentML120.Generated.SpectrumIdentificationResultType()
                    {
                        id = "SIR_" + scan_result_scan_item.Item1,
                        spectraData_ref = "SD_" + spectral_ids[psm.FullFilePath].ToString(),
                        spectrumID = psm.NativeId,
                        SpectrumIdentificationItem = new mzIdentML120.Generated.SpectrumIdentificationItemType[500],
                        cvParam = new mzIdentML120.Generated.CVParamType[1]
                        {
                            new mzIdentML120.Generated.CVParamType
                            {
                ...
                _mzid.DataCollection.AnalysisData.SpectrumIdentificationList[0].SpectrumIdentificationResult[scan_result_scan_item.Item1].SpectrumIdentificationItem[scan_result_scan_item.Item2] = new mzIdentML120.Generated.SpectrumIdentificationItemType()
                {
                    rank = 1,
                    ...
                    PeptideEvidenceRef = new mzIdentML120.Generated.PeptideEvidenceRefType[psm.BestMatchingPeptides.Select(p => p.Peptide).Distinct().Count()],
                    cvParam = new mzIdentML120.Generated.CVParamType[2]
                    {
                        new mzIdentML120.Generated.CVParamType
                        {
                ...
                foreach (PeptideWithSetModifications p in psm.BestMatchingPeptides.Select(p => p.Peptide).Distinct())
                {
                    _mzid.DataCollection.AnalysisData.SpectrumIdentificationList[0].SpectrumIdentificationResult[scan_result_scan_item.Item1].SpectrumIdentificationItem[scan_result_scan_item.Item2].PeptideEvidenceRef[pe]
                        = new mzIdentML120.Generated.PeptideEvidenceRefType
                        {
            ...
            _mzid.AnalysisProtocolCollection = new mzIdentML120.Generated.AnalysisProtocolCollectionType()
            {
                ...
                {
                    new mzIdentML120.Generated.SpectrumIdentificationProtocolType
                    {
                        id = "SIP",
                        analysisSoftware_ref = "AS_MetaMorpheus",
                        SearchType = new mzIdentML120.Generated.ParamType
                        {
                            Item = new mzIdentML120.Generated.CVParamType
                            {
                        ...
                        AdditionalSearchParams = new mzIdentML120.Generated.ParamListType()
                        {
                            //TODO: ADD SEARCH PARAMS?
                            Items = new mzIdentML120.Generated.AbstractParamType[2]
                            {
                                new mzIdentML120.Generated.CVParamType
                                {
                        ...
                        ModificationParams = new mzIdentML120.Generated.SearchModificationType[fixedMods.Count + variableMods.Count],
                        Enzymes = new mzIdentML120.Generated.EnzymesType()
                        {
                            Enzyme = new mzIdentML120.Generated.EnzymeType[proteases.Count]
                        },
                        FragmentTolerance = new mzIdentML120.Generated.CVParamType[2]
                        {
                            new mzIdentML120.Generated.CVParamType
                            {
                       ...
                       ParentTolerance = new mzIdentML120.Generated.CVParamType[2]
                        {
                              new mzIdentML120.Generated.CVParamType
                            {
                                accession = "MS:1001412",
                        ...
                        Threshold = new mzIdentML120.Generated.ParamListType()
                        {
                            Items = new mzIdentML120.Generated.CVParamType[1]
                            {
                                new mzIdentML120.Generated.CVParamType
                                {
            ...
            {
                _mzid.AnalysisProtocolCollection.SpectrumIdentificationProtocol[0].Enzymes.Enzyme[protease_index] = new mzIdentML120.Generated.EnzymeType()
                {
                    ...
                    EnzymeName = new mzIdentML120.Generated.ParamListType()
                    {
                        Items = new mzIdentML120.Generated.AbstractParamType[1]
                        {
                            new mzIdentML120.Generated.CVParamType
                            {
            ...
            {
                _mzid.AnalysisProtocolCollection.SpectrumIdentificationProtocol[0].ModificationParams[mod_index] = new mzIdentML120.Generated.SearchModificationType()
                {
                    fixedMod = true,
            ...
            _mzid.AnalysisProtocolCollection.ProteinDetectionProtocol = new mzIdentML120.Generated.ProteinDetectionProtocolType()
            {
                id = "PDP",
                analysisSoftware_ref = "AS_MetaMorpheus",
                Threshold = new mzIdentML120.Generated.ParamListType()
            ...
            if (groups != null)
            {
                _mzid.DataCollection.AnalysisData.ProteinDetectionList = new mzIdentML120.Generated.ProteinDetectionListType()
                {
                    id = "PDL",
                    ProteinAmbiguityGroup = new mzIdentML120.Generated.ProteinAmbiguityGroupType[groups.Count]
                };
                ...
                {
                    _mzid.DataCollection.AnalysisData.ProteinDetectionList.ProteinAmbiguityGroup[group_id] = new mzIdentML120.Generated.ProteinAmbiguityGroupType()
                    {
                        id = "PAG_" + group_id,
                        ProteinDetectionHypothesis = new mzIdentML120.Generated.ProteinDetectionHypothesisType[proteinGroup.Proteins.Count]
                    };
                    int pag_protein_index = 0;
                    foreach (Protein protein in proteinGroup.Proteins)
                    {
                        _mzid.DataCollection.AnalysisData.ProteinDetectionList.ProteinAmbiguityGroup[group_id].ProteinDetectionHypothesis[pag_protein_index] = new mzIdentML120.Generated.ProteinDetectionHypothesisType()
                        {
                            id = "PDH_" + protein_id,
                            ...
                            PeptideHypothesis = new mzIdentML120.Generated.PeptideHypothesisType[proteinGroup.AllPeptides.Count],
                            cvParam = new mzIdentML120.Generated.CVParamType[4]
                            {
                            new mzIdentML120.Generated.CVParamType
                            {
                        ...
                        foreach (PeptideWithSetModifications peptide in proteinGroup.AllPeptides)
                        {
                            if (peptide_evidence_ids.ContainsKey(peptide))
                            {
                                ...
                                {
                                    _mzid.DataCollection.AnalysisData.ProteinDetectionList.ProteinAmbiguityGroup[group_id].ProteinDetectionHypothesis[pag_protein_index].PeptideHypothesis[peptide_id] = new mzIdentML120.Generated.PeptideHypothesisType()
                                    {
                                        peptideEvidence_ref = "PE_" + peptide_evidence_ids[peptide],
                                        SpectrumIdentificationItemRef = new mzIdentML120.Generated.SpectrumIdentificationItemRefType[peptide_ids[peptide.FullSequence].Item2.Count],
                                    };

                                    int i = 0;
                                    foreach (string sii in peptide_ids[peptide.FullSequence].Item2)
                                    {
                                        _mzid.DataCollection.AnalysisData.ProteinDetectionList.ProteinAmbiguityGroup[group_id].ProteinDetectionHypothesis[pag_protein_index].PeptideHypothesis[peptide_id].SpectrumIdentificationItemRef[i] = new mzIdentML120.Generated.SpectrumIdentificationItemRefType()
                                        {
        ...
        private static mzIdentML120.Generated.CVParamType GetUnimodCvParam(Modification mod, bool appendMotifToModNames)
        {
            if (mod.DatabaseReference != null && mod.DatabaseReference.ContainsKey("Unimod"))
            {
                return new mzIdentML120.Generated.CVParamType()
                {
